...
.PHONY: build
build: build-image ## Build the all other docker images
...
.PHONY: restart
restart: validate-variables ## Restart docker container
	@$(DOCKER_COMPOSE) restart $(DOCKER_SERVICE_NAME)

.PHONY: config
config: validate-variables ## List docker container configuration
